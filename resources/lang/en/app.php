...
return [
    ...
    */
    ...
    'introduction' => [
        ...
        'tools'   => 'There are tools to analyse the roster and squad states of guild members. It makes use of great game data interfaces provided by the like of swgoh.gg or swgoh.help. It is WIP and currently has Macht Wächter guild links hardcoded. Will be available to any player/guild soonTM.',
    ],
    'data_keys' => [
        'updated' => 'Updated',
        'player' => 'Player',
